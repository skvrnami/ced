...
for (d in donationform) {
  ...
  data <- data %>%
    mutate(
      ...
      birthdate = ifelse(firstname == "Jiří" & surname == "Strnad" & birthdate == ymd("1959-06-26"), 
                         ymd("1959-09-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      ...
      birthdate = ifelse(birthdate == ymd("1962-12-25") & firstname == "Bojko", ymd("1962-01-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      ...
      birthdate = ifelse(birthdate == ymd("1982-11-30") & firstname == "Dlouhý", ymd("1980-11-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      ...
      birthdate = ifelse(birthdate == ymd("1961-10-25") & firstname == "Čechová", ymd("1961-10-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      ...
      birthdate = ifelse(birthdate == ymd("1947-09-10") & surname == "Boublík", ymd("1974-09-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      ...
      birthdate = ifelse(birthdate == ymd("1963-01-11") & surname == "Liška", ymd("1963-10-11"), format(as.Date(birthdate),'%Y-%m-%d')),
  ...
  data <- data %>%
    mutate(
      birthdate = ifelse(birthdate == ymd("1972-06-01") & surname == "Majringer", ymd("1972-06-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-09-19") & surname == "Lejsková", ymd("1963-09-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1955-11-11") & surname == "Landa", ymd("1955-11-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-02-15") & surname == "Lameš", ymd("1962-01-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-02-26") & surname == "Křížek", ymd("1975-02-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1975-08-23") & surname == "Kyselý", ymd("1973-08-23"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-12-07") & surname == "Kučera", ymd("1977-12-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-07-05") & surname == "Kufrová", ymd("1948-07-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-04-07") & surname == "Kubíček", ymd("1951-05-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-02-17") & surname == "Kubský", ymd("1953-02-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1961-04-08") & surname == "Kubiena", ymd("1961-08-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-24") & surname == "Krása", ymd("1951-11-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-09-16") & surname == "Kronus", ymd("1963-11-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-10-22") & surname == "Krause", ymd("1979-10-23"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-01") & surname == "Kouřil", ymd("1972-01-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-30") & surname == "Konšel", ymd("1966-01-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-04-07") & surname == "Kolaříková", ymd("1975-06-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1949-07-06") & surname == "Klejma", ymd("1949-07-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-10-25") & surname == "John", ymd("1964-10-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1952-05-06") & surname == "Jirotka", ymd("1952-06-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-10-14") & surname == "Jelínek", ymd("1970-10-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-05-07") & surname == "Janů", ymd("1964-10-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-20") & surname == "Janderka", ymd("1949-12-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-03-08") & surname == "Hájek", ymd("1963-02-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-04-17") & surname == "Jalovec", ymd("1948-01-27"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-06-12") & surname == "Jech", ymd("1967-05-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1978-02-23") & surname == "Babáčková", ymd("1978-02-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1948-05-01") & surname == "Balcarová", ymd("1948-05-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1965-12-10") & surname == "Bačák", ymd("1975-12-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1965-12-11") & surname == "Denk", ymd("1966-12-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1975-06-19") & surname == "Dolanský", ymd("1975-06-13"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1961-03-23") & surname == "Drbohlav", ymd("1961-03-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1969-07-12") & surname == "Dvořák", ymd("1969-06-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1956-08-26") & surname == "Bradáč", ymd("1956-08-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-11-14") & surname == "Kladivová", ymd("1972-11-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-09-05") & surname == "Felner", ymd("1967-04-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1937-07-16") & surname == "Filák", ymd("1937-03-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-12-02") & surname == "Flesar", ymd("1961-12-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-08-10") & surname == "Fojt", ymd("1968-08-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1955-05-17") & surname == "Forišková", ymd("1956-05-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-07-26") & surname == "František", ymd("1969-07-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-11-17") & surname == "Gogelová", ymd("1967-12-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-04-01") & surname == "Grolich", ymd("1984-06-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-08-29") & surname == "Hainc", ymd("1988-07-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-08-04") & surname == "Kodrík", ymd("1960-08-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("1956-05-13") & surname == "Kollová", ymd("1956-05-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-12-02") & surname == "Kozubík", ymd("1966-12-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-04-14") & surname == "Krajíček", ymd("1966-04-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1974-06-12") & surname == "Král", ymd("1984-06-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1957-03-23") & surname == "Kuběna", ymd("1957-03-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1974-06-05") & surname == "Kvitová", ymd("1972-06-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1969-07-01") & surname == "Mikošková", ymd("1969-07-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1982-10-21") & surname == "Netolický", ymd("1982-09-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-11-21") & surname == "Novotný", ymd("1978-11-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1956-02-01") & surname == "Pagáčova", ymd("1959-02-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1950-11-02") & surname == "Poláčková", ymd("1951-11-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1981-03-01") & surname == "Herot", ymd("1982-03-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1951-05-04") & surname == "Hlisnikovský", ymd("1951-05-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-06-18") & surname == "Horut", ymd("1984-06-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-06-24") & surname == "Horák", ymd("1984-07-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-03-04") & surname == "Hromek", ymd("1977-03-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-08-09") & surname == "Hrubý", ymd("1968-08-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-05-15") & surname == "Jastrzembská", ymd("1960-05-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1985-12-27") & surname == "Jůnová", ymd("1989-12-27"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1970-01-07") & surname == "Stejskal", ymd("1970-10-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1952-08-27") & surname == "Trávníček", ymd("1952-08-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1973-12-29") & surname == "Tučková", ymd("1972-12-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1958-02-10") & surname == "Tvarůžek", ymd("1958-02-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1972-08-12") & surname == "Tylš", ymd("1972-08-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1949-12-05") & surname == "Urbánek", ymd("1949-11-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-08-21") & surname == "Vodáková", ymd("1998-08-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-05-23") & surname == "Váša", ymd("1971-06-23"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-03-21") & surname == "Změlíková", ymd("1963-03-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1968-11-28") & surname == "Černín", ymd("1986-11-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1958-01-21") & surname == "Šlahúnková", ymd("1958-02-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-07-05") & surname == "Chval", ymd("1961-07-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-05-19") & surname == "Říha", ymd("1964-05-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1980-08-01") & surname == "Šmídek", ymd("1980-08-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1961-11-19") & surname == "Štefek", ymd("1961-11-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1957-05-26") & surname == "Štěpánek", ymd("1957-03-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1952-06-26") & surname == "Švecová", ymd("1952-06-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1950-01-06") & surname == "Halíková", ymd("1950-06-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1978-06-30") & surname == "Janda", ymd("1978-09-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1954-03-11") & surname == "Jirousová", ymd("1954-02-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1981-09-01") & surname == "Kotala", ymd("1981-01-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1955-02-07") & surname == "Kováčik", ymd("1955-07-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-11-03") & surname == "Mackovík", ymd("1967-03-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1953-11-09") & surname == "Mandát", ymd("1953-11-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("1947-10-18") & surname == "Muchová", ymd("1947-09-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1947-08-02") & surname == "Pospíšil", ymd("1947-02-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-01-01") & surname == "Sekeráková", ymd("1964-11-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-12-16") & surname == "Vrzal", ymd("1964-12-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-08-10") & surname == "Hlaváček", ymd("1960-08-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1981-04-19") & surname == "Kinčl", ymd("1981-04-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-09-29") & surname == "Pleskač", ymd("1989-09-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1975-07-11") & surname == "Ruso", ymd("1965-07-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-09-07") & surname == "Sovová", ymd("1966-09-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1997-10-22") & surname == "Adamec", ymd("1977-10-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-08-07") & surname == "Binka", ymd("1979-07-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-01-05") & surname == "Brůžek", ymd("1977-07-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1997-05-16") & surname == "Bíbr", ymd("1977-05-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-04-22") & surname == "Bohuňková", ymd("1978-04-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-07-04") & surname == "Chaloupka", ymd("1983-07-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-01-28") & surname == "Florián", ymd("1989-01-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-03-07") & surname == "Galata", ymd("1976-07-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1958-07-28") & surname == "Holubová", ymd("1959-07-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1990-06-25") & surname == "Housa", ymd("1990-06-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1900-01-01") & surname == "Hájek", ymd("1983-09-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-03-01") & surname == "Janata", ymd("1954-01-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-04-13") & surname == "Janek", ymd("1989-04-13"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-10-08") & surname == "Janovský", ymd("1988-09-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1987-09-04") & surname == "Jelínek", ymd("1987-04-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1995-12-15") & surname == "Jokeš", ymd("1989-12-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-05-08") & surname == "Karasaridis", ymd("1991-05-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1994-12-24") & surname == "Kindl", ymd("1994-11-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-02-14") & surname == "Kluka", ymd("1972-02-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1968-05-26") & surname == "Koumarová", ymd("1968-08-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-03-24") & surname == "Kožich", ymd("1960-03-31"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-08-04") & surname == "Lochmanová", ymd("1989-08-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1964-03-12") & surname == "Mendl", ymd("1964-03-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1955-07-06") & surname == "Mrázek", ymd("1955-06-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-06-20") & surname == "Naiclerová", ymd("1972-06-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-07-12") & surname == "Nešpor", ymd("1984-01-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1994-09-06") & surname == "Noha", ymd("1994-06-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1986-05-23") & surname == "Novotná", ymd("1986-05-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1972-10-05") & surname == "Novák", ymd("1972-05-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-06-15") & surname == "Otto", ymd("1971-06-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-04-17") & surname == "Pařízek", ymd("1984-05-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-06-26") & surname == "Paška", ymd("1983-06-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1952-02-29") & surname == "Petr", ymd("1952-02-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1987-03-03") & surname == "Pešán", ymd("1987-02-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1995-10-28") & surname == "Podroužek", ymd("1991-10-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-08-17") & surname == "Pravda", ymd("1969-08-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1970-09-03") & surname == "Rendl", ymd("1970-03-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1989-08-21") & surname == "Rozsypal", ymd("1982-08-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-05-08") & surname == "Rusóová", ymd("1977-05-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-05-28") & surname == "Sadílek", ymd("1983-05-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("1989-09-08") & surname == "Simkanič", ymd("1989-04-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-09-05") & surname == "Suchanek", ymd("1984-09-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1991-10-15") & surname == "Svrček", ymd("1991-10-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-09-29") & surname == "Sáňková", ymd("1978-09-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-03-18") & surname == "Síkora", ymd("1983-03-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1991-05-06") & surname == "Sýkora", ymd("1991-06-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1972-09-03") & surname == "Tomis", ymd("1972-03-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1984-05-08") & surname == "Toušek", ymd("1984-08-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1978-09-07") & surname == "Třešňáková", ymd("1978-07-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1995-11-28") & surname == "Urbánek", ymd("1985-11-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1994-04-19") & surname == "Vidláková", ymd("1998-04-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("1987-05-25") & surname == "Vrba", ymd("1987-05-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-07-26") & surname == "Zach", ymd("1983-01-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-06-30") & surname == "Zemánek", ymd("1962-06-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1991-09-19") & surname == "Zámečník", ymd("1982-09-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-02-29") & surname == "Čermáková", ymd("1976-02-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-02-14") & surname == "Čáha", ymd("1989-02-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-01-04") & surname == "Šemík", ymd("1962-01-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-11-03") & surname == "Žák", ymd("1989-11-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1973-06-25") & surname == "Bakošová", ymd("1976-06-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-01-25") & surname == "Bojko", ymd("1962-12-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1995-03-29") & surname == "Impseil", ymd("1995-03-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1987-01-21") & surname == "Kachlík", ymd("1972-01-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1948-08-28") & surname == "Moudrý", ymd("1948-08-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-09-04") & surname == "Plevková", ymd("1983-09-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1956-03-02") & surname == "Severová", ymd("1956-03-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1957-12-01") & surname == "Wawrzacz", ymd("1957-01-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-05-01") & surname == "Čech", ymd("1960-05-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1961-10-15") & surname == "Čechová", ymd("1961-10-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1963-07-10") & surname == "Štefcová", ymd("1963-10-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-04-07") & surname == "Švancarová", ymd("1967-04-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-02-03") & surname == "Bouška", ymd("1979-02-23"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1945-10-01") & surname == "Cetkovský", ymd("1945-10-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-09-18") & surname == "Davídek", ymd("1966-09-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-05-20") & surname == "Dohnal", ymd("1976-05-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1985-02-05") & surname == "Drbohlav", ymd("1985-02-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-03-13") & surname == "Flek", ymd("1988-03-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1969-06-07") & surname == "Hejma", ymd("1969-07-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1954-03-29") & surname == "Horník", ymd("1954-03-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-09-14") & surname == "Horák", ymd("1968-09-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1961-02-02") & surname == "Hrabě", ymd("1969-02-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1980-01-11") & surname == "Jirovský", ymd("1980-10-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-05-12") & surname == "Karásková", ymd("1977-05-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-10-25") & surname == "Kuklová", ymd("1971-01-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1962-11-07") & surname == "Marešová", ymd("1962-11-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-01-27") & surname == "Bílová", ymd("1976-01-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-04-29") & surname == "Müller", ymd("1966-04-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("1972-08-02") & surname == "Quittová", ymd("1972-09-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-11-15") & surname == "Vávra", ymd("1974-11-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-01-20") & surname == "Čejka", ymd("1979-01-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1986-10-29") & surname == "Šperl", ymd("1986-10-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1976-09-19") & surname == "Švancara", ymd("1976-09-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1983-08-23") & surname == "Uzel", ymd("1983-08-24"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1954-04-30") & surname == "Chvojka", ymd("1965-04-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-07-21") & surname == "Janíček", ymd("1973-07-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1955-04-30") & surname == "Nedvědický", ymd("1955-05-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-03-17") & surname == "Med", ymd("1971-03-09"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-07-20") & surname == "Pavelek", ymd("1971-07-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1954-04-03") & surname == "Procházková", ymd("1954-04-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1970-03-04") & surname == "Tregner", ymd("1970-03-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-09-22") & surname == "Netolický", ymd("1982-09-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1988-08-25") & surname == "Polanský", ymd("1988-08-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2021-01-17") & surname == "Eliáš", ymd("1984-01-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1947-04-04") & surname == "Košek", ymd("1947-06-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1950-09-29") & surname == "Snopek", ymd("1970-09-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1975-06-12") & surname == "Stránský", ymd("1962-06-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-07-22") & surname == "Šlachta", ymd("1971-07-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1970-10-28") & surname == "Bravenec", ymd("1970-07-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2001-10-16") & surname == "Knapovský", ymd("2001-10-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1981-08-18") & surname == "Kufa", ymd("1981-08-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1948-10-11") & surname == "Otevřel", ymd("1948-01-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1980-07-23") & surname == "Pelán", ymd("1980-08-23"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-09-26") & surname == "Techlovský", ymd("1972-03-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1970-09-27") & surname == "Urban", ymd("1970-07-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1993-03-11") & surname == "Vorba", ymd("1992-03-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1971-12-14") & surname == "Špitálský", ymd("1970-12-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1957-01-21") & surname == "Andreska", ymd("1957-01-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-27") & surname == "Bartošík", ymd("1965-01-27"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-02-17") & surname == "Bednářová", ymd("1967-02-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-07-12") & surname == "Bedrnová", ymd("1969-06-13"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-03-17") & surname == "Bečán", ymd("1965-01-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-03") & surname == "Bečvář", ymd("1973-05-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2000-12-12") & surname == "Blažková-Šípková", ymd("1955-12-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2000-07-05") & surname == "Bárta", ymd("1944-07-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-12-11") & surname == "Cholasta", ymd("1951-12-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1965-12-11") & surname == "Císař", ymd("1965-01-27"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-12-11") & surname == "Dobrovolná", ymd("1959-10-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-11-19") & surname == "Doležal", ymd("2000-11-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-07-07") & surname == "Drbohlav", ymd("1966-06-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-04-15") & surname == "Dupalová", ymd("1928-08-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1985-07-05") & surname == "Endrle", ymd("1985-05-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-05-07") & surname == "Fendrych", ymd("1971-05-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1994-12-03") & surname == "Fraitová", ymd("1944-12-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-07-07") & surname == "Fuchs", ymd("1949-07-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-05-29") & surname == "Funioková", ymd("1957-08-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-05-29") & surname == "Funioková", ymd("1957-08-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-16") & surname == "Golian", ymd("1958-06-16"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1948-04-30") & surname == "Hanuš", ymd("1949-04-30"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-09-26") & surname == "Holub", ymd("1968-09-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse(birthdate == ymd("2022-04-10") & surname == "Novosád", ymd("1950-04-10"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-07-31") & surname == "Neuman", ymd("1953-12-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1969-05-18") & surname == "Nejedlý", ymd("1969-01-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1978-04-13") & surname == "Míkovcová Mališová", ymd("1976-09-01"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-11-20") & surname == "Musílek", ymd("1958-09-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-03-18") & surname == "Mišáková", ymd("1957-03-18"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1960-01-20") & surname == "Mareš", ymd("1960-01-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-09-13") & surname == "Mareš", ymd("1948-09-13"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2020-04-07") & surname == "Makl", ymd("1974-07-22"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2000-11-17") & surname == "Malý", ymd("1956-03-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-07-31") & surname == "Švarc", ymd("1944-05-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-31") & surname == "Šustalová", ymd("1974-01-31"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-02") & surname == "Štyrand", ymd("1958-01-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-07-31") & surname == "Špulák", ymd("1978-05-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1979-03-11") & surname == "Špacír", ymd("1979-08-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1977-02-05") & surname == "Šimek", ymd("1974-02-05"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-17") & surname == "Čada", ymd("1965-12-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-07-02") & surname == "Zach", ymd("1958-07-02"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2021-05-03") & surname == "Vraná", ymd("1960-05-03"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-01-12") & surname == "Vorel", ymd("1956-07-12"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1966-10-26") & surname == "Vepřek", ymd("1966-10-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1978-06-28") & surname == "Vašíček", ymd("1978-06-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-05-06") & surname == "Vandasová", ymd("1963-08-06"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1959-03-31") & surname == "Vajchr", ymd("1960-03-31"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1973-02-15") & surname == "Uhlíř", ymd("1973-12-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-12-11") & surname == "Trnková", ymd("1968-11-28"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1959-12-01") & surname == "Soukup", ymd("1955-12-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-12-11") & surname == "Smékal", ymd("1976-09-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2022-03-17") & surname == "Sláma", ymd("1976-10-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1967-01-07") & surname == "Sekera", ymd("1967-12-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1973-02-11") & surname == "Sedlmajer", ymd("1972-02-11"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("1969-06-25") & surname == "Reiser", ymd("1959-06-25"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-12-11") & surname == "Pšenička", ymd("1955-01-29"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse(birthdate == ymd("2023-06-08") & surname == "Pilich", ymd("1947-06-08"), format(as.Date(birthdate),'%Y-%m-%d')),
      
      birthdate = ifelse((birthdate == ymd("1975-05-27") | birthdate == ymd("2022-02-27")) & surname == "Žáčková", ymd("1975-02-27"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("1957-01-26") | birthdate == ymd("1957-03-26")) & surname == "Mužík", ymd("1947-03-26"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2022-02-14") | birthdate == ymd("2022-05-14")) & surname == "Neliba", ymd("1969-02-14"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2000-12-19") | birthdate == ymd("2021-12-19")) & surname == "Šoral", ymd("1955-12-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2022-01-07") | birthdate == ymd("2023-05-21")) & surname == "Zdobinský", ymd("1993-01-07"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2023-06-09") | birthdate == ymd("2023-11-17")) & surname == "Suralová", ymd("1957-11-17"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2022-02-19") | birthdate == ymd("2002-02-19")) & surname == "Spurný", ymd("1975-02-19"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2023-07-31") | birthdate == ymd("2022-04-20")) & surname == "Riedel", ymd("1961-04-20"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("2022-03-15") | birthdate == ymd("2022-11-24")) & surname == "Frelová", ymd("1975-03-15"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("1948-10-06") | birthdate == ymd("1948-10-02")) & surname == "Všetečka", ymd("1948-10-21"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("1983-08-04") | birthdate == ymd("1986-07-04")) & surname == "Havran", ymd("1986-08-04"), format(as.Date(birthdate),'%Y-%m-%d')),
      birthdate = ifelse((birthdate == ymd("1989-07-29") | birthdate == ymd("1993-07-29")) & surname == "Pešková", ymd("1973-07-29"), format(as.Date(birthdate),'%Y-%m-%d'))
...
# Filter and save the data where financial_donation > 0
financial_donation_nonzero <- data %>% filter(financial_donation > 0)

# Load the non-financial donation data
financial_data <- readRDS("intermediate_data/donation_data_financial_clean.rds")

financial_data <- financial_data %>% filter(financial_donation == 0)
# Merge the datasets
...
merged_data <- merged_data %>% filter(_merge == 3)

# Append the previously saved data
final_data <- bind_rows(merged_data, fileA)
...
final_data <- final_data %>%
  mutate(id = group_indices(., polparty, surname, firstname, birthdate))

# Calculate the length of academic degrees
final_data <- final_data %>%
  mutate(length_degree_bn = nchar(acadegree_bn),
         length_degree_bn = ifelse(length_degree_bn == 1, 0, length_degree_bn),
         length_degree_an = nchar(acadegree_an),
         length_degree_an = ifelse(length_degree_an == 1, 0, length_degree_an),
         length = length_degree_an + length_degree_bn)

# Sort by id and length
final_data <- final_data %>%
  arrange(id, desc(length))

# Replace academic degrees with the previous row's value if the id matches
final_data <- final_data %>%
  group_by(id) %>%
  mutate(acadegree_bn = ifelse(id == lag(id), lag(acadegree_bn), acadegree_bn),
         acadegree_an = ifelse(id == lag(id), lag(acadegree_an), acadegree_an)) %>%
  ungroup()

# Drop temporary columns
final_data <- final_data %>%
  select(-starts_with("length"), -id)
...
collapsed_data <- final_data %>%
  group_by(polparty, surname, firstname, birthdate, year) %>%
  summarise(acadegree_an = first(acadegree_an),
            acadegree_bn = first(acadegree_bn),
            donation_all = sum(donation_all),
...
# Save the final data
write.dta(collapsed_data, "data/data_donation_oofppm.dta")
