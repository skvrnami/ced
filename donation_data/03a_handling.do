use donation_data_financial.dta, clear 
...
replace financial_donation = částkaKč 
...
keep acadegree_an acadegree_bn financial_donation surname year firstname birthdate polparty
...
gen dm = 0
replace dm = 1 if financial_donation == 0

collapse (sum) financial_donation (first) acadegree_an acadegree_bn , by(polparty surname firstname birthdate year dm)

sort polparty surname firstname birthdate year dm
save donation_data_financial_clean.dta, replace 