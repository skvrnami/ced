use donation_data_nonfinancial.dta, clear 
...
gen nonfinancial_donation = .
replace nonfinancial_donation = částkaKč if částkaKč !=. 
replace nonfinancial_donation = hodnotaBÚPKč if hodnotaBÚPKč !=. 

keep surname firstname acadegree_an acadegree_bn birthdate year polparty nonfinancial_donation
...
collapse (sum) nonfinancial_donation (first) acadegree_an acadegree_bn , by(polparty surname firstname birthdate year)

sort polparty surname firstname birthdate year
save donation_data_nonfinancial_clean.dta, replace 
